...
namespace gfx_testing::sdl {
    ...
    SdlShader SdlShader::loadShader(SdlContext const &context, const std::filesystem::path &shaderSourcePath,
        ...
        auto backendFormats = SDL_GetGPUShaderFormats(context.mDevice);
