...
namespace gfx_testing::scene {
    ...
    Scene::Scene(game::GameContext &gameContext) :
        ...
        mPropObjects(gameContext, gameContext.mResourceLoader.loadObjModel("basic-shapes.obj"),
                     translate(glm::mat4(1.0f), OBJECT_POSITION)),
        mDebugAxes(gameContext, gameContext.mResourceLoader.loadObjModel("debug-axes.obj"),
                   glm::mat4(1.0f)),
